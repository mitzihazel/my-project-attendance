...
$UpdateQuery = "UPDATE  `att`.`2s2` SET  `pcs` =  '$_POST[pcs]' WHERE  pcs='$_POST[hidden]' and id='$_POST[id]'";

mysql_query($UpdateQuery,$con);
};
$sql = "SELECT id,pcs FROM 2s2";
...
echo "<form action=postpcs2s2.php method=post>";
echo "<tr>";
